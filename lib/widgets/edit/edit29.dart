...
class Edit29 extends StatefulWidget {
  final Function(String) callback;
  final Color color;
  Edit29({this.color = Colors.black, required this.callback});

  @override
  _Edit29State createState() => _Edit29State();
}

class _Edit29State extends State<Edit29> {
...
class CodePainter extends CustomPainter {
  ...
  final Color color;
  CodePainter({required this.textCode, this.color = Colors.black});
