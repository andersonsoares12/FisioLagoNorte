...
class Loader32 extends StatefulWidget {

  final Color color1;
  final Color color2;
  final Color color3;

  Loader32({this.color1 = Colors.deepOrangeAccent, this.color2 = Colors.yellow, this.color3 = Colors.lightGreen});

  @override
  _Loader32State createState() => _Loader32State();
}

class _Loader32State extends State<Loader32> with TickerProviderStateMixin {
